...
// Canvas layer stack + locking rules for Podcast Design Canvas (#5).
//
...
(function (global) {
  ...
  // Starter stack for the canvas step. Branding is locked by default — the common case.
  ...
  // A locked layer cannot move; neighbors cannot swap into a locked slot.
  ...
  // Top of list draws on top — walk from bottom to top for the preview stage.
