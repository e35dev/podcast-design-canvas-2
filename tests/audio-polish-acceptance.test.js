...
(async () => {
  ...
  // 4) Reload: the episode session record round-trips through serialize/deserialize with
  // every track's polished asset intact (the way resuming an episode restores it).
